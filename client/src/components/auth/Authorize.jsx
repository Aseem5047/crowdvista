...
const Authorize = ({
	...
	return (
		<>
			<div className="grid lg:grid-cols-2 min-w-[18rem] max-w-full sm:max-w-[75%] lg:max-w-[70rem] h-[40rem]  border border-gray-300 shadow-lg rounded-xl gap-4 animate-slide-in-left m-auto overflow-x-hidden overflow-y-scroll no-scrollbar ">
				{/* Authentication Form */}
